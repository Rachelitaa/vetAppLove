...
public class PetsAdapter extends ArrayAdapter<AddPet> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        petSpecie.setText("Especie: " + pets.getSpecies());
        petBdate.setText("Birthday: " + pets.getBdateAddPet());
        petBreed.setText("Breed: " + pets.getBreed());
        petGender.setText("Gender: " + pets.getGenderAddPet());
